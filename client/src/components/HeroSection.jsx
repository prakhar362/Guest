...
import headerimg from '../assets/hotel.jpg';
const HeroSection = () => {
    return (
      <div className="grid w-full grid-cols-1 my-auto  mt-12 mb-8 md:grid-cols-2 xl:gap-14 md:gap-2">
        <div className="flex flex-col justify-center col-span-1 text-center lg:text-start">
          
        <h1 className="mb-8 -mt-10 text-4xl ml-4 font-bold leading-tight lg:text-6xl text-dark-grey-900">
<span className="text-red-600"> Escape  </span> the Ordinary,<br />
  <span className="text-blue-900"> Embrace </span> 
  the Extraordinary.
</h1>

<h2 class="text-3xl font-semibold text-dark-grey-900 ml-4">
  <span class="text-dark-grey-900">Elevate your stay</span> with <span class="text-yellow-400">comfort that inspires</span><br />
